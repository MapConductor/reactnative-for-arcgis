...
import { ArcGISMapViewHolder } from './ArcGISMapViewHolder.native';
    ...
    NativeMapExtensionCapable
{
  ...
  constructor(
    private readonly nativeRef: React.RefObject<ArcGISMapViewRef | null>,
    cameraPosition: MapCameraPosition
  ) {
    super();
    this.cameraPosition = cameraPosition;
    this.holder = new ArcGISMapViewHolder(nativeRef);
  }
